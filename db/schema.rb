...
ActiveRecord::Schema[7.0].define(version: 20_240_102_005_559) do
  ...
  create_table 'practice_advices', force: :cascade do |t|
    t.integer 'user_id', null: false
    t.integer 'golf_course_id', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['golf_course_id'], name: 'index_practice_advices_on_golf_course_id'
    t.index ['user_id'], name: 'index_practice_advices_on_user_id'
  end
  ...
  create_table 'practice_days', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id content], name: 'index_practice_days_on_user_id_and_content', unique: true
  ...
  add_foreign_key 'practice_advices', 'golf_courses'
  add_foreign_key 'practice_advices', 'users'

class Score < ApplicationRecord
  ...
  validates :second_shot_distance, inclusion: { in: %w(no_shot two_hundred_shot_over shot_within_two_hundredone_from_hundred_fifty shot_within_hundred_fifty_from_hundred within_hundred_yard) }
  enum second_shot_distance: { no_shot: 0, two_hundred_shot_over: 1, shot_within_two_hundredone_from_hundred_fifty: 2, shot_within_hundred_fifty_from_hundred: 3, within_hundred_yard: 4}

  validates :approach_shot, inclusion: { in: %w(no_approach_shot pulled_it_nside_the_two_pin on_the_green missed_the_green) }

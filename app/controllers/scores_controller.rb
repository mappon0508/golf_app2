...
class ScoresController < ApplicationController
  ...
  def create
    ...
    if @hole_number == 18
      # 18番ホールの場合、ラウンド終了へ遷移
      redirect_to score_path(id: @score.golf_play_record_id)
    else
  ...
  def score_params
    params.require(:score).permit(:content, :tee_shot, :second_shot_distance, :approach_shot, :approach,
                                  :bunker_save, :long_putt, :short_putt, :golf_play_record_id, :hole_id, :putt)
  end
end
